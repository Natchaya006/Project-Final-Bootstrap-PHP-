      ...
      <nav class="navbar-default navbar-side" role="navigation">
          <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
              ...
              <li>
                <a href="adminHome.php" class = "active"><i class="glyphicon glyphicon-hand-right"></i>Home</a>
              </li>
              <li>
        ...
        <div class="col-sm-offset-3">
          ...
          echo '<br><br><br><h3>Total number of users &nbsp;<b><u>'.$numrows.'</u></b></h3><br>';
          ...
          $result = mysqli_query($connect,$sql);
    			$numrows = mysqli_num_rows($result);
          echo '<h3>Total number of movies &nbsp;<b><u>'.$numrows.'</u></b></h3><br>';
           ?>
