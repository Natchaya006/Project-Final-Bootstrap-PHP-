...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
      ...
      <nav class="navbar-default navbar-side" role="navigation">
          <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
              ...
              <li>
                <a href="adminMovie.php" class = "active"><i class="glyphicon glyphicon-hand-right"></i>View Movie</a>
              </li>
              <li>
    ...
    else
    {
      ...
      echo '<form action="viewMovie.php" name="frmMain" method="post" target="iframe_target">';
