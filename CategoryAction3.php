<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div class="col-lg-11 col-lg-offset-3 col-sm-offset-4">
      <h3><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class = "glyphicon glyphicon-cd"></span>&nbsp;&nbsp;KONG</b></h3><br>
    </div>
    <div class="container">
      <div class="col-lg-offset-3 col-md-offset-5 col-sm-offset-5 col-md-3 col-sm-3 col-lg-3">
        <img src="assets/img/Action/new-kong-skull-island-poster-16291-230x300.jpg" class = "img-rounded" style="width:100%">
      </div>
      <div style="background-color: #F5F5F5;"class="col-lg-6 col-sm-4">
        <p style="padding-top:15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เรื่องย่อ ภาพยนตร์เรื่องนี้ว่าด้วยเรื่องราวการเดินทางของช่างภาพหนังสือพิมพ์สาว วีเวอร์ Kong Skull Island คอง มหาภัยเกาะกะโหลก ในภารกิจเยือนเกาะลึกลับแห่งหนึ่ง กับคณะทีมสำรวจติดอาวุธ ภายใต้การคุ้มครองของผู้กอง เจมส์ คอนราด อดีตเจ้าหน้าที่ทีมสำรวจ แต่ปรากฏว่าสถานการณ์ไม่ได้เป็นไปอย่างที่คิด เมื่อจุดประสงค์ที่แท้จริงของการมาเยือนเกาะลึกลับ เกี่ยวข้องกับยุคประวัติศาสตร์ที่สาบสูญนี้ ได้ถูกเปิดเผย พร้อมด้วยอันตรายจากการปรากฏตัวของคิงคองขนาดยักษ์ที่จู่โจมพวกเขาแบบไม่ทันตั้งตัว รวมไปถึงการเผชิญหน้ากับอันตรายในป่าลึกอื่นๆ ที่จะเปิดทุกอณูสัมผัสให้ตื่นตัวมากกว่าเคย ผู้สร้างภาพยนตร์พยายามสร้างความแตกต่างจนอาจทำให้ผู้ชมที่เคยดูเวอร์ชั่นก่อนต้องงงไปสักพักหนึ่ง มันมีทั้งความสนุก นอกจากนี้แล้วยังเป็นการโฟกัสเรื่องราวโดยอ้างอิงจากจักรวาลของ Godzilla โดยสัตว์ประหลาดทั้งหลายในเรื่องไม่ใช่แค่โผล่ออกมาแล้วก็ตาย แต่มันยังมีฉากให้พวกมันได้ต่อสู้และโชว์ความสามารถอย่างเต็มที่เรียกได้ว่าต้องห้ามพลาด</p>
        <a href="https://www.youtube.com/watch?v=J7ILAOJMJKM">Trailer</a><br><br>
        <form action="BuyMovie.php" method="post">
          <?php
          $id = $_SESSION["id"];
          echo '<input type="hidden" name = "mid" value = "8">';
