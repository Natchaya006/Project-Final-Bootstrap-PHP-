...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
      ...
      <nav class="navbar-default navbar-side" role="navigation">
          <div class="sidebar-collapse">
            ...
            $connect = mysqli_connect("localhost","id1494919_admin","admin","id1494919_movie_shop");
              ...
              <li>
                <a href="adminUser.php" ><i class="glyphicon glyphicon-hand-right"></i>View User</a>
              </li>
              <li>
                <a href="adminOrder.php" class = "active"><i class="glyphicon glyphicon-hand-right"></i>View Order</a>
              </li>
              <li>
    ...
    else
    {
      ...
      echo '<form action="viewOrder.php" name="frmMain" method="post" target="iframe_target">';
      echo '<h3>Total number of orders &nbsp;<b><u>&nbsp;'.$numrows.'&nbsp;</u></b></h3><br>';
      echo '<b>Report : </b>&nbsp;&nbsp;<select name = "title">';
      echo '<option value = "Movie ID">Movie ID</option>';
