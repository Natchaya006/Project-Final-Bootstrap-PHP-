<html lang="en">
  ...
  <body>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                  <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="active"><a href="NewMovieIndex.php">New Movie</a></li>
    ...
    <div class="container">
      <div class="col-lg-offset-1 col-lg-3 col-md-offset-1 col-md-3 col-sm-3 col-sm-offset-1">
        <img src="assets/img/HotNew/Fast-And-Furious-8-2017-เร็ว.webp" class = "img-rounded" style="width:100%">
      </div>
      <div style="background-color: #F5F5F5;"class = "col-lg-offset-5 col-md-offset-5 col-sm-offset-5">
